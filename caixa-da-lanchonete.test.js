...
describe('CaixaDaLanchonete', () => {
    ...
    ])('compra simples em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, item) => 
    validaTeste(formaDePagamento, resultadoEsperado, [item]));

    test.each([
        ['credito', 'R$ 11,85', ['cafe,1', 'sanduiche,1', 'queijo,1']],
        ['debito', 'R$ 11,50', ['cafe,1', 'sanduiche,1', 'queijo,1']],
    ])('compra de 3 itens em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) => 
    validaTeste(formaDePagamento, resultadoEsperado, itens));
    ...
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, item) =>
        validaTeste(formaDePagamento, resultadoEsperado, [item]));
